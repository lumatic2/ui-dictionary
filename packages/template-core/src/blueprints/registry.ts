...
export const blueprintRegistry: TemplateBlueprint[] = [
  {
    id: 'business-card-minimal', format: 'business-card', width: 1050, height: 600, density: 'airy', priority: 10, gridColumns: 3,
    slots: [
  ...
  {
    id: 'product-poster-hero', format: 'product-poster', width: 1080, height: 1350, density: 'balanced', priority: 10, gridColumns: 1,
    slots: [
  ...
  {
    id: 'infographic-stats', format: 'infographic', width: 1200, height: 1600, density: 'balanced', priority: 10, gridColumns: 1,
    slots: [
