...
## 관찰 갤러리 (기법이 아니라 사례를 본다)

- **60fps.design** — iOS·웹 앱의 마이크로인터랙션·전환·제스처 디테일 큐레이션. `https://60fps.design/` (접근일 2026-07-28)
- **landing.love** — 애니메이션 랜딩 갤러리, 풀페이지 영상 기록 — 스크롤 페이싱·히어로 전환 관찰용. `https://www.landing.love/` (접근일 2026-07-28)
- **Brainwave Interactive Landing** — 애니메이션 헤비 AI 제품 랜딩 완성 사례(히어로 레이어링·스크롤 트리거 섹션). `https://github.com/arnobt78/Brainwave-Interactive-Landing--React-Frontend` (접근일 2026-07-28)

판정 이력: 위 3건 + 공간형 랜딩 팩은 absorption-criteria **B(링크 참조)** — 재서술·벤더링 금지, 관찰 소스로만 (`research/2026-07-28-vi7-toolshelf-placement.md`).
