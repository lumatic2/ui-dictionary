...
import { ColorPaletteGeneratorDemo } from "@/components/color-palette-generator"
import { CursorReactiveField } from "@/components/cursor-reactive-field"
...
export function HeroSearch({
  ...
  return (
    <div ref={rootRef} className="relative mt-7 w-full max-w-2xl">
      ...
      {open && (
        <div className="absolute left-0 right-0 top-full z-20 mt-2 overflow-hidden rounded-md border border-border bg-popover p-2 text-left shadow-xl shadow-foreground/10">
