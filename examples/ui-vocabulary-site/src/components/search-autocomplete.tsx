...
const groupIcons: Partial<Record<TermGroupId, LucideIcon>> = {
  ...
  "structure-content-elements": LayoutPanelTop,
  "feedback-alerts-toasts": Bell,
  "feedback-loading-progress": LoaderCircle,
  "feedback-empty-error": Inbox,
  "feedback-access-limits": Lock,
  "feedback-confirmation-help": CircleAlert,
  "feedback-status-notifications": Activity,
  "feedback-interaction-states": MousePointerClick,
  "data-tables-lists": Rows3,
  "data-basic-content-elements": GalleryHorizontal,
  "data-chat-messaging": Bell,
  "data-account-support": UserRound,
  ...
  "data-motion-content": WandSparkles,
  "style-surface-material": Palette,
  "style-border-color": Palette,
  "style-typography": Type,
  "style-tokens": Palette,
  "style-decorative-effects": Sparkles,
  "layout-spacing-sizing": Ruler,
  "layout-responsive-viewport": PanelBottom,
  "layout-stacking-overflow": PanelsTopLeft,
  "layout-scroll-behavior": Navigation,
  "accessibility-aria-screen-reader": Focus,
  "accessibility-focus-motion": Focus,
}
