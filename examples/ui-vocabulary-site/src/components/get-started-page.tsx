    ...
    <section className="min-h-[calc(100svh-3.5rem)] bg-muted/40 px-5 py-16 md:px-8 lg:px-10">
      <div className="mx-auto flex max-w-[1180px] flex-col gap-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[1.55fr_1fr]">
          <button
            className="group overflow-hidden rounded-2xl border bg-card p-8 pb-0 text-left shadow-sm transition hover:border-foreground/25"
            type="button"
          ...
          <button
            className="group flex flex-col rounded-2xl border bg-card p-8 text-left shadow-sm transition hover:border-foreground/25"
            type="button"
        ...
        <button
          className="group grid gap-8 overflow-hidden rounded-2xl border bg-card p-8 text-left shadow-sm transition hover:border-foreground/25 lg:grid-cols-[1fr_1.1fr]"
          type="button"
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <button
            className="group flex flex-col gap-4 rounded-2xl border bg-card p-7 text-left shadow-sm transition hover:border-foreground/25"
            type="button"
