// Palette generator core: seed library, palette math, quality scoring, and
// candidate rotation for the color-palette-generator tool. Pure module — no
// JSX — registered as a code asset so the tool can reference it through the
// registry (asset-reference path). Color values here are palette content.
