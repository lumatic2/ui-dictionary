...
export const recipeGalleryEntries: RecipeGalleryEntry[] = [
  ...
  { slug: "mesh-gradient-surface", title: "Mesh Gradient Surface", collection: "Marketing", description: "An organic multi-point color field built from layered token-derived radial-gradients — pure CSS, static by default." },
  { slug: "grain-texture-overlay", title: "Grain Texture Overlay", collection: "Marketing", description: "Subtle feTurbulence noise layered above a surface to remove gradient banding and add film texture — SVG data URI, zero JS." },
  { slug: "scroll-driven-reveal", title: "Scroll-Driven Reveal", collection: "Marketing", description: "Content fades and rises in as it enters the scrollport via CSS view-progress timelines — no scroll listeners, safe static fallback." },
  { slug: "magnetic-hover-button", title: "Magnetic Hover Button", collection: "Marketing", description: "A CTA that leans toward the cursor and springs back on leave — an explicit-request showcase accent, never a product-wide default." },
  { slug: "pinned-scroll-sequence", title: "Pinned Scroll Sequence", collection: "Marketing", description: "A section pins while scroll scrubs a multi-step narrative, then releases — the tier ② escalation (GSAP ScrollTrigger) that CSS scroll timelines cannot express." },
  { slug: "shader-gradient-surface", title: "Shader Gradient Surface", collection: "Marketing", description: "An animated organic mesh gradient computed per-frame on the GPU behind a lazy boundary — the tier ④ escalation of the static CSS mesh-gradient-surface." },
  { slug: "spring-drag-snap-card", title: "Spring Drag Snap-back Card", collection: "Application UI", description: "A draggable card whose spring return is interruptible — grab it mid-flight and it re-targets without a snap, unlike duration tweens." },
  { slug: "staggered-entrance-group", title: "Staggered Entrance Group", collection: "Application UI", description: "Sibling items animate in with tightly offset start times so a list reads as one coherent arrival instead of a simultaneous pop." },
  { slug: "canvas-particle-field", title: "Canvas Particle Field", collection: "Application UI", description: "Dozens of drifting dots drawn into a 2D pixel buffer as ambient backdrop texture — aria-hidden decoration with an explicit reduced-motion static frame." },
  { slug: "lazy-three-object-scene", title: "Lazy three.js Object Scene", collection: "Application UI", description: "A lit 3D object rendered with three.js strictly behind a dynamic import — the lazy boundary is the pattern, not an optimization." },
  { slug: "glass-panel", title: "Glass Panel", collection: "Overlays", description: "Keeps foreground content legible over a busy backdrop by blurring what is behind it, with a translucent token-derived fill." },
  ...
  { slug: "docs-site", title: "Docs Site", collection: "Docs", description: "A composed documentation site skeleton: navbar with Cmd-K search, a version switcher that swaps the sidebar tree, and guide, API reference, and changelog pages." },
  ...
  { slug: "saas-app-shell", title: "SaaS App Shell", collection: "Layout", description: "A composed application skeleton: sidebar shell, dashboard with stats, chart, and members table, plus a sectioned settings page." },
  { slug: "marketing-landing", title: "Marketing Landing", collection: "Marketing", description: "A composed standard-funnel landing page: hero, logo strip, story, terminal demo proof, comparison, pricing, FAQ, and final CTA — every section an independent file." },
  ...
  { slug: "adaptive-navigation-container", title: "Adaptive Navigation Container", collection: "Navigation", description: "One destination set resolved by rule into in-page tabs, a bottom tab bar, or a navigation rail depending on destination count and width class." },
