<!--
출처: getdesign.md — MiniMax design analysis
- 확보 경로: `npx -y getdesign@latest add minimax` (getdesign.md 공식 CLI)
- 페이지: https://www.getdesign.md/minimax/design-md (접근일 2026-07-31)
- 용도: SP1 영상 재현 랩 한정 (CLAUDE.md 「하지 않는 것」 — 타 브랜드 아이덴티티를 최종 아이덴티티로 복사하지 않는다)
- 아래는 CLI가 내려준 원문 그대로 (무수정)
-->
