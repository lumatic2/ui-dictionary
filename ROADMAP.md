...
> Status: 편집기 색·토큰 편집 — ECT1~ECT3 완료. ECT4(이미지 노드·키 계약) 진행 — step-1 완료. **ECT5는 사용자 브라우저 필요로 대기.** 직전 horizon(판독성) closed 2026-07-21, 기준 6(판단 가능성) 미달이 이 horizon의 개설 근거
...
<!-- harness:milestone id="ECT4" status="active" priority="P1" -->
