...
<!-- harness:milestone id="FW" status="active" priority="P0" -->
### FW — Feed Wiring
...
- Evidence: `docs/plans/2026-07-12-fw-feed-wiring.md`, changesets, `packages/component-registry` 생성 카탈로그·테스트, E2E 스크린샷
