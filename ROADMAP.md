...
<!-- harness:milestone id="VI1" status="active" priority="P0" -->
### VI1 — 표현 스택 지도
...
- Evidence: 활성화 시 plan doc + `docs/research/2026-07-17-expressive-stack-genealogy.md`
...
<!-- harness:milestone id="VI2" status="pending" priority="P1" -->
