...
<!-- harness:milestone id="SCD1" status="completed" priority="P1" evidence="changesets/20260710-principles-gate-open/README.md" -->
...
- Evidence: changesets/20260710-principles-gate-open/README.md
- Gap: "AI 티 안 나는 UI"가 제품 차별점인데 그 철학이 사용자 대면·에이전트 소비 어디에도 문서화돼 있지 않음 — 암묵 규칙으로 산재.
- Status: [x]

- Completed at: 2026-07-10
- Summary: 8개 원칙 정본·llms.txt·한국어 Docs 공개, 사용자 승인 및 Cloudflare 배포 검증 완료

<!-- harness:milestone id="SCD2" status="active" priority="P1" -->
...
- None within the active horizon after SCD2.
