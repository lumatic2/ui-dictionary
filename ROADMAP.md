...
> Status: 편집기 판독성·조작감 — EU1(선택·핸들) 착수. 직전 horizon(제작 경화) closed 2026-07-20, 기준 7 미달 명시가 이 horizon의 개설 근거
...
## Active Milestones
<!-- harness:milestone id="EU1" status="active" priority="P0" -->
### EU1 — 조작 종류가 구분되는 선택
...
<!-- harness:milestone id="EU2" status="pending" priority="P0" -->
### EU2 — 스냅·정렬 가이드·거리 측정
...
<!-- harness:milestone id="EU3" status="pending" priority="P0" -->
### EU3 — 레이어 패널 판독성
...
<!-- harness:milestone id="EU4" status="pending" priority="P0" -->
### EU4 — 인스펙터 정보구조
...
<!-- harness:milestone id="EU5" status="pending" priority="P1" -->
### EU5 — 판단 가능성 게이트
