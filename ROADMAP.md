...
> Status: **goal `dark-carryover` 완주 (2026-08-01)** — M2 토큰 전수 승격 · M3 forced-colors · M4 og-image 다크 PNG 실배포. active goal 0. 남은 큐: 『인터랙티브 웹 애니메이션』 책 스터디 자산화(사용자 주도) — real-use-lap 은 2026-07-31 폐기.
