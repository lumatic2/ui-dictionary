...
> Status: Studio Finish closed 2026-07-19 (SF1~SF3 완료) — 다음 horizon은 사용자 결정 대기 (`plans/horizons/CANDIDATES.md`)
> North star: Build Askewly Design as both a public reference website and an agent-usable implementation system.
> line budget: <=150

## Current Horizon

<!-- harness:goal id="studio-finish" status="completed" -->
...
<!-- harness:milestone id="SF3" status="completed" priority="P1" evidence="evidence/studio-finish/sf3-preview-e2e.md, changesets/20260719-preview-dark/README.md, changesets/20260719-preview-responsive/README.md" -->
### SF3 — 미리보기 고도화 (다크·반응형)
...
- Completed at: 2026-07-19
- Summary: 다크·모바일 토글 + 12조합 매트릭스 + 통합 루프 실측
