...
> Status: 템플릿 제작 시스템 경화 — TH1~TH4·TH7·TH9 완료, TH5 진행 중 → TH10 → TH11 → TH6(close). TH8은 리서치 재수집 후
...
<!-- harness:milestone id="TH5" status="active" priority="P1" -->
...
<!-- harness:milestone id="TH10" status="pending" priority="P1" -->
### TH10 — 편집기 결함 마감
...
<!-- harness:milestone id="TH11" status="pending" priority="P1" -->
