...
> Status: 템플릿 제작 시스템 경화 — TH1~TH3·TH7 완료, TH4(검증 실체화) 진행 중 → TH9 → TH5 → TH6 → TH8
...
- Completed at: 2026-07-20
<!-- harness:milestone id="TH9" status="pending" priority="P0" -->
### TH9 — 텍스트 맞춤
- DoD: 6청사진 × 2세트 산출물 12장에 캔버스를 넘치는 텍스트 0 + 넘침을 기계로 검출하는 게이트 + 한글·라틴 혼용 문자열에서 검증.
- Evidence: evidence/template-production-hardening/th9-text-fitting.md
...
<!-- harness:milestone id="TH4" status="active" priority="P0" -->
### TH4 — 검증 실체화
...
- Note: TH7 완료로 blocker 해소 — 이제 게이트가 "SVG에 토큰 색이 실재하는가"를 검사할 수 있다
