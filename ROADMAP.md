...
> Status: Structure-First Buildout — SFB1 완료, SFB2 active (horizon-run 연쇄)
...
<!-- harness:milestone id="SFB2" status="active" priority="P1" -->
...
- Evidence: docs/plans/2026-07-10-sfb2-shell-buildout.md + changeset README들 + dev 렌더 스모크.
