...
<!-- harness:milestone id="TPS4" status="completed" priority="P0" evidence="evidence/template-production-system/tps4-packs.md" -->
### TPS4 — 명함·제품 포스터·인포그래픽 팩
- DoD: 6개 청사진이 형식 고유 제약을 지키며 core/studio에서 편집·내보내기된다.
- Evidence: evidence/template-production-system/tps4-packs.md
- Gap: 기준 청사진 1종씩만 있어 형식 고유 변형·정확성 검증 부족
- Scale: changesets>=3; surfaces: format packs·catalog matrix; capability: 3형식 실사용 팩
- Status: [x]

- Completed at: 2026-07-19
- Summary: 세 형식 6청사진 + 안전영역·CTA·연락처·데이터 무결성
<!-- harness:milestone id="TPS3" status="completed" priority="P0" evidence="evidence/template-production-system/tps3-studio.md, changesets/20260719-template-studio-renderer/README.md, changesets/20260719-template-studio-edit-export/README.md" -->
### TPS3 — 브라우저 템플릿 스튜디오
- DoD: 세 fixture를 보고 수정하고 HTML/SVG/JSON으로 내보낸 뒤 JSON 왕복 상태를 복원한다.
...
- Gap: CanvasDocument를 사람이 편집·내보낼 좁은 제품 표면 부재
- Scale: changesets>=2; surfaces: Vite browser app·Playwright; capability: 편집·내보내기 루프
- Status: [x]

- Completed at: 2026-07-19
- Summary: CanvasDocument 브라우저 렌더·텍스트 편집·JSON/HTML/SVG 왕복
<!-- harness:milestone id="TPS2" status="completed" priority="P0" evidence="evidence/template-production-system/tps2-compiler.md, changesets/20260719-blueprint-selection/README.md, changesets/20260719-deterministic-template-compiler/README.md" -->
### TPS2 — 구성 청사진·결정론적 조립기
- DoD: 세 기준 fixture가 재현 가능한 유효 장면을 만들고 실패경로가 원인 코드와 함께 거부된다.
...
- Gap: 형식 선택과 장면 컴파일을 재현 가능한 코어로 분리해야 함
- Scale: changesets>=2; surfaces: blueprint registry·compiler; capability: 결정론적 장면 조립
- Status: [x]

- Completed at: 2026-07-19
- Summary: 세 형식 청사진 선택 + 결정론적 CanvasDocument 컴파일·서명
<!-- harness:milestone id="TPS1" status="completed" priority="P0" evidence="evidence/template-production-system/tps1-contract.md, changesets/20260719-template-contract/README.md, changesets/20260719-template-core-scaffold/README.md" -->
### TPS1 — 템플릿 계약·장면 기반
- DoD: 편집 템플릿/평면 시안 경계가 문서·타입·검증에 동일하게 나타나고 유효/무효 fixture가 구분된다.
...
- Gap: DESIGN.md 결정을 편집 가능한 장면으로 조립하는 계층 부재
- Scale: changesets>=2; surfaces: TypeScript core·fixture; capability: 구조화 템플릿 정본
- Status: [x]

- Completed at: 2026-07-19
- Summary: 구조화 템플릿 경계 + CanvasDocument image/shape + template-core 검증 기반
<!-- harness:milestone id="RC1" status="completed" priority="P0" evidence="evidence/recipe-code-reuse/rc1-transplant.md, changesets/20260719-registry-pipeline/README.md, changesets/20260719-registry-llms/README.md" -->
...
- Completed at: 2026-07-19
- Summary: 27자산 registry 빌드+순수성 게이트+깨끗한 프로젝트 이식 실구동
<!-- harness:milestone id="RC2" status="completed" priority="P0" evidence="evidence/recipe-code-reuse/rc2-agent-e2e.md, changesets/20260719-code-first-contract/README.md, changesets/20260719-code-first-e2e/README.md" -->
...
- Completed at: 2026-07-19
- Summary: 코드 출발 계약 배포 + headless 이식·프로젝트 토큰 재결합·브라우저 실증
<!-- harness:milestone id="RC3" status="completed" priority="P1" evidence="evidence/recipe-code-reuse/rc3-composition-map.md, changesets/20260719-composition-recipe-map/README.md, changesets/20260719-composition-recipe-contract/README.md" -->
### RC3 — 스튜디오 구성 ↔ 레시피 매핑
...
- Completed at: 2026-07-19
- Summary: 구성 13항 recipes 매핑+payload 노출+계약 배선 (피어 실측·독립 리뷰)
<!-- harness:milestone id="RC4" status="completed" priority="P1" evidence="evidence/recipe-code-reuse/rc4-demo.md, changesets/20260719-rc4-demo/README.md" -->
...
- Completed at: 2026-07-19
- Summary: 사용자 실선택 전 루프 + 사람 게이트 승인 — Close Criteria 5/5
