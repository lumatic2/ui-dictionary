...
<!-- harness:milestone id="QA1" status="active" priority="P0" -->
...
- Evidence: `docs/plans/2026-07-12-qa1-recipe-gallery-visual-qa.md`, changesets, sweep 산출물
- Gap: recipe 19종은 사람이 화면에서 본 적 없음(live render 부재), design-qa 패스 0회.
- Status: [ ]
