...
<!-- harness:milestone id="ST1" status="completed" priority="P0" evidence="changeset + evidence/cascade-studio/" -->
...
- Summary: 구현·실측 검증·배포 완료
<!-- harness:milestone id="ST2" status="completed" priority="P0" evidence="changeset + evidence/cascade-studio/" -->
...
- Completed at: 2026-07-19
- Summary: 구현·실측 검증·배포 완료
<!-- harness:milestone id="ST3" status="completed" priority="P0" evidence="changeset + evidence/cascade-studio/" -->
...
- Completed at: 2026-07-19
- Summary: 구현·실측 검증·배포 완료
<!-- harness:milestone id="ST4" status="active" priority="P1" -->
### ST4 — 카피·인터랙션 축 + 통합 실연
