...
<!-- harness:milestone id="SF1" status="active" priority="P0" -->
### SF1 — 데이터 주도 스튜디오 주입 (자동화)
- DoD: 데이터 JSON + `make-studio.py` 1커맨드로 스튜디오 HTML 생성 실구동(기본·커스텀 각 1) + 불량 JSON 명시 에러 + 계약 배포(구 지시 grep 0).
- Evidence: `plans/2026-07-19-sf1-studio-data-injection.md`, `evidence/studio-finish/`
...
<!-- harness:milestone id="SF2" status="pending" priority="P0" -->
