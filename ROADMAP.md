...
> Status: H2 Living Design System closed (2026-07-12) — 다음 horizon 활성화는 사용자 결정 대기
> North star: Build Askewly Design as both a public reference website and an agent-usable implementation system.
> line budget: <=150

## Current Horizon

<!-- harness:goal id="living-design-system" status="completed" -->
Goal (closed 2026-07-12): 흡수 루프 운영화 + 전 표면 확장 + 산출의 4-소비처 자동 공급. 4 milestones (RL/MS/FW/SD) complete; close audit in `docs/horizons/2026-07-living-design-system.md`, milestone history in `BACKLOG.md`.
