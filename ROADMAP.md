...
<!-- harness:milestone id="SF2" status="active" priority="P0" -->
### SF2 — 구성 패턴 완편 (4유형 + 예약형)
- DoD: 구성 4유형 미리보기 반영 전수 실측 + 예약형 절 llms 배포 + 조건 노출 경계 확인.
- Evidence: `plans/2026-07-19-sf2-composition-patterns.md`, `research/2026-07-19-st4-composition-patterns.md`
...
<!-- harness:milestone id="SF3" status="pending" priority="P1" -->
### SF3 — 미리보기 고도화 (다크·반응형)
