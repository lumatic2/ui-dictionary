...
<!-- harness:milestone id="DOG1" status="active" priority="P0" -->
### DOG1 — 검사기가 맞는 것만 잡는다
...
<!-- harness:milestone id="DOG2" status="pending" priority="P0" -->
### DOG2 — 남의 프로젝트에서 돈다
...
- Status: [ ] — step-2는 사용자 승인 정지점(공개 배포는 되돌릴 수 없다)

<!-- harness:milestone id="DOG3" status="pending" priority="P1" -->
### DOG3 — 타이포 단계를 센다
...
<!-- harness:milestone id="DOG4" status="pending" priority="P1" -->
