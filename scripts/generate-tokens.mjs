...
const COLOR_MAPPINGS = [
  ...
  ["--destructive-foreground", "color.semantic.text.on-destructive"],
  ["--border", "color.semantic.border.default"],
  ["--input", "color.semantic.border.input"],
  ["--ring", "color.semantic.border.focus"],
  ["--primary-hover", "color.semantic.action.primary-hover"],
  ["--emphasis-surface", "color.semantic.emphasis.surface"],
  ["--emphasis-foreground", "color.semantic.emphasis.foreground"],
  ...
  ["--info-link-hover", "color.semantic.status.info-link-hover"],
  ["--success-surface", "color.semantic.status.success-surface"],
  ["--success-foreground", "color.semantic.status.success-foreground"],
  ["--danger-surface", "color.semantic.status.danger-surface"],
  ["--danger-foreground", "color.semantic.status.danger-foreground"],
  ["--danger-solid", "color.semantic.status.danger-solid"],
  ["--danger-solid-hover", "color.semantic.status.danger-solid-hover"],
];
