...
const FIXED_ASSETS = [
  ...
  },
  {
    ...
    items: [
      ...
      ["docs/design-system/copy-language.md", "Copy language policy (ko/en mixing): UI terms, proper nouns, code, and demo content stay English; the site's own voice (intros, guidance, empty states) is Korean in haeyo-che — includes the per-surface judgment table and CTA mixing forms"],
    ],
  },
  {
    section: "Tokens",
