...
| 214 | 20260721-no-asset-fallback | 2026-07-21 | VL3 step 3: 자산 없는 용어 481개의 구현 경로 신설 — 용어 항목 자체를 재료로. combobox로 실증(부위 4/4, 경계 2/2 미위반, tsc 통과). 규약이 없는 레시피를 요구하지 않는지 순환 probe 확인 | 4/4 | complete |
| 215 | 20260721-decision-format-contract | 2026-07-21 | VL4 step 1: 판별 데이터 계약. 군집은 분류가 아니라 오판 나는 묶음이라 별도 네임스페이스, 그리고 모델이 이미 아는 구분은 적지 않는다(VL1 기준선 근거) | 2/2 | complete |
| 216 | 20260721-decision-validator | 2026-07-21 | VL4 step 2: 검증기 6검사(교차 군집 모순 포함). 깨진 fixture 5종 전부 exit 1 + 원인 지목 | 5/5 | complete |
| 217 | 20260721-disclosure-family-decision | 2026-07-21 | VL4 step 3: 첫 군집 펼침류(축 6·규칙 7). 분리력 검증이 규칙 순서 결함 적발 — 표면 축이 개수 축보다 먼저 와야 한다. 수정 후 후보 6종 전부 뽑힘 | 3/3 | complete |
...
| 226 | 20260721-vl8-observation-setup | 2026-07-21 | VL8 step 1: 관측 준비(과업 3건·판정 기준·자산 스냅샷)를 관측 전에 확정. 사전 설명 금지 조건을 이번엔 지키지 못한다는 한계를 명시 — 재는 것이 '처음 보는 사람'이 아니라 '만든 사람의 실제 요구' | 0/0 | complete |
