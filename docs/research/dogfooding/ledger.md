...
### 마감 기록 — DF-4 사용자 면제 (2026-07-17)

DF-4(기회주의 건)는 사용자 결정으로 스킵하고 AD3를 마감한다. 근거: 장부의 목적(마찰·갭 수집)은 DF-1~DF-3으로 달성됐고, 수집된 갭 4건은 AD4(changesets #110–111)에서 전부 자산으로 해소됐다. 판정 의무(entry-protocol 명문)의 실효성은 차기 horizon의 실작업에서 자연 관측한다. 이후 실작업 관측이 생기면 이 장부에 DF-5부터 append해도 된다(장부는 살아있는 기록으로 유지).
